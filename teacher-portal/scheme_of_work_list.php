                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered" id="dataTable_8" width="100%" cellspacing="0">
                                        ...
                                        <tbody> 
                                                  ...
                                                  $result = $Loader-> FetchSchemeOfWork($school_code, $teacher_code, $subject);
                                                  ...
                                                  foreach($result as $active)
                                                  {
                                                    ...
                                                    $data_id  = $active['id'];
                                                      if($active['teacher_id'] == $teacher_code){
														$dataCheck ='   
														<a  href="scheme_of_work_edit.php?SOW='.$active['id'].'"><div class="btn btn-info mb-1">Edit</div></a> <br/> 
													  ...
													  {
														$dataCheck = '   
														<div>You can not edit/delete</div>   
														 ';
													  }
