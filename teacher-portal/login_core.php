...
<html lang="en">
    <head>
		...
		?>
        <meta property='og:image'         content='https://adminportal.com.ng/login/gen_img/teacher_admin_bg.jpg'>
        <meta property='twiter:image'     content='https://adminportal.com.ng/login/gen_img/teacher_admin_bg.jpg'>
        <meta property='og:title'         content="TEACHERS ADMIN LOGIN  ">
        <meta property="og:image:type"    content="image/jpeg">
        <meta property="og:image:width"   content="700">
        <meta property="og:image:height"  content="700">
        <meta property='og:description'   content="School teachers admin access login" >	
        <meta property='og:url'           content='https://adminportal.com.ng/login/gen_img/teacher_admin_bg.jpg'>
        <meta property='og:site_name'     content="TEACHERS ADMIN LOGIN"> 
        <meta property='og:type'          content='https://adminportal.com.ng/login/gen_img/teacher_admin_bg.jpg'>

		<title> TEACHERS PORTAL LOGIN </title>
    </head>
    <body class="bg-primary" style="background-image: url('../gen_img/teacher_admin_bg.jpg');  background-repeat: no-repeat; background-size: 100vw 100vh;  ">
                        ...
                        <div class="row justify-content-center text-white">
                            <div class="col-lg-5">
                                <div class="card shadow-lg border-0 rounded-lg mt-5 bg-dark">
                                    <div class="card-header"><h3 class="text-center font-weight-light my-4"> TEACHERS PORTAL<br />
                                    LOGIN</h3>
                                </div>
                                    <div class="card-body">
								...
								<form method="POST"   id="user_login_form">
											<div class="form-group">
													...
													<input type="text" name="user_email_address" placeholder="email address"  id="user_email_address" class="form-control" data-parsley-checkemail data-parsley-checkemail-message='Email address does not exist' />
											</div>
                                            ...
                                            <div class="form-group d-flex align-items-center justify-content-between mt-4 mb-0">
                                                <a class="small" href="account_recovery/"></a>
                                    ...
                                    <div class="card-footer text-center">
                                        ...
                                        <div class="small">
										<small>Developed By Hebzihub Nig Ltd</small>
										</div>
