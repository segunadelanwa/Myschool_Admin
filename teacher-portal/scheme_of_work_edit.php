...
<html lang="en">
    <head>
		...
		$sow_id = $_GET['SOW'];
		$Loader->query = "SELECT * FROM `scheme_of_uploader` WHERE `school_code` = '$school_code' AND `teacher_id` = '$teacher_code' AND `id` = '$sow_id' "; 
		...
		foreach($result as $active)
		{
		  ...
		  $scheme_term = $active['scheme_term']; 
		...
		{
			header("Location: scheme_of_work_list.php");
		}
         ...
         <main>
                    <div class="container-fluid">
                        ...
                        <ol class="breadcrumb mb-4">
                            ...
                            <li class="breadcrumb-item active">Scheme Of Work Edit</li>
                        </ol>
													...
													<div class="table-responsive">
														  ...
														  <div class="form-group">
                                                           ...
                                                           <div class="form-group ">
															...
															<option value="<?php echo$scheme_term; ?>" selected='selected'><?php echo$scheme_term; ?> </option>
                                                          ...
                                                          <div class="form-group">	
																...
																<option  value='<?php echo $subject_id; ?>' selected='selected'> <?php echo$subjectName?> </option>";
																<?php		
																...
																<option  value='<?php echo $class; ?>' selected='selected'><?php echo $class; ?> </option>
																...
																<option  value='<?php echo $week; ?>' selected='selected'>Week <?php echo $week; ?> </option>
															...
															<input type="text" name='topic' id='topic'  value='<?php echo $topic; ?>' class="form-control py-4"   required />
															</div>

                                                            <div class="form-group">
														    <label>Content </label> 
															<textarea name='content' id='content' style='height:150px;' class='form-control ' value='<?php echo $content; ?>'><?php echo $content; ?></textarea>
														   </div> 

 
                                              
																	
																	<input type="hidden" name="sow_id"   value='<?php echo$sow_id; ?>'    />
																	<input type="hidden" name="page"   value='updateSchemeOfWork' />
																	<input type="hidden" name="action" value="updateSchemeOfWork" />

																	<input type="submit" name="admin_signup" id="admin_signup" class="btn btn-primary" value="Update Scheme">
																</div>
															</form>
					  ...
					  if(data.success == 'success')
						  {
							...
							elementmodal.classList.add('loaderDisplayNone');	
							   alert(data.feedback);
							   window.location.href="scheme_of_work_list.php";
