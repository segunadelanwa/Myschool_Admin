        ...
        <div id="layoutSidenav">
		 ...
		 <div class="table-responsive">
	   		    ...
	   		    <div id="otpupdatebox" style="background-color:white; padding:50px;margin-top:10px">
					<div  style="text-align:center;"><b>SUSPEND SCHOOL ACTIVITIES</b></div>
				...
				<div style="display:flex">
					...
					<input class="form-control" placeholder="School ID"   type="text" name="class_id" id="class_id" class="form-control"  />
					</div>
					...
					<select   id="categories_selection"  name="categories_selection" onchange="calender(this.id)"  class="form-control" >
						...
						<option value="status">Check Account Status</option> 
						<option value="active">Lift Suspend</option> 
