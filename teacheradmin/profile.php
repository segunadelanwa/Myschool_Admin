                                        ...
                                        <div class="table-responsive">
                                          <table class="table table-bordered"   width="50%" cellspacing="0">
                                              ...
                                              <tbody>
                                                  ...
                                                  <tr style="width:100%;">
                                                      <td style="width:20%;">School Bank Details:</td> 
                                                      <td style="width:80%;"> 
                                                        <h6>Account Name: <?php echo $account_name; ?></h6>
                                                        <h6>Account Number: <?php echo $account_number; ?></h6>
                                                        <h6>Bank Name:<?php echo $bank_name; ?></h6>
                                                      </td> 
                                                  </tr>
