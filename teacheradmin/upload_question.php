                                                        ...
                                                        <div class="form-group ">
														  ...
														  <div class="form-group">
                                                           ...
                                                           <div class="card-header">
															...
															Suggested  Question ID: ( <?php echo$result = $Loader->QuestionAccessSuggestion();?> )
														    </div>
														  ...
														  <div class="form-group">
                                                           ...
                                                           QUESTION SETTINGS
                                                            ...
                                                            Note: Teacher must maintain the same  question ID to upload specific Subject Exam/Test questions.<br/>
															 Each student will use  the same question ID to take the uploaded Subject Exam/Test at student portal <br><br>
      
															 However, if you have uploaded specific Subject Questions and you need to add more questions to it,
															 all you need is to get the formal uploaded question ID and use it to upload the new question you want to add  <br><br>

															Always keep your Exam/Test question ID safe, else the Exam/Test won't be accessible by your student 
															</small>
													</div>
												</div>
