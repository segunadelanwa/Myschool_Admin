						   ...
						   <div class="col-md-12">  
												...
												<div class="card-body">
													...
													<div class="table-responsive">
																...
																<div id="otpupdatebox" style="background-color:white; padding:50px;">
																		<?php
																				if(isset($_GET["student_id"]))
																			{
																				...
																				$failed="";
                                                                                        ...
                                                                                        <div class="card mb-5">
																									...
																									foreach($result as $row)
																									{
																											...
																											<div style='width:10%'  class='btn btn-white'><input type='number' oninput='handleData(this.value)' max='30'  class='form-control'/> </div>
...
let scoreData = '';
 ...
 function addSubject(sub_id,stu_code) {
	...
	if(scoreData <= 30)
	{
		...
		alert('Exam student score can not be more than 70Marks ');
	}
