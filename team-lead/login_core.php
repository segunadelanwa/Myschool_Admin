...
<html lang="en">
    <head>
		...
		?>
        <meta property='og:image'         content='https://adminportal.com.ng/login/gen_img/agent_admin_bg.jpg'>
        <meta property='twiter:image'     content='https://adminportal.com.ng/login/gen_img/agent_admin_bg.jpg'>
        <meta property='og:title'         content="TEAM LEAD LOGIN  ">
        <meta property="og:image:type"    content="image/jpeg">
        <meta property="og:image:width"   content="700">
        <meta property="og:image:height"  content="700">
        <meta property='og:description'   content="Hebzihub Nigeria Limited agent admin access login" >	
        <meta property='og:url'           content='https://adminportal.com.ng/login/gen_img/agent_admin_bg.jpg'>
        <meta property='og:site_name'     content="TEAM LEAD LOGIN"> 
        <meta property='og:type'          content='https://adminportal.com.ng/login/gen_img/agent_admin_bg.jpg'>


		<title> TEAM LEAD LOGIN </title>
    </head>
    <body class="bg-primary" style="background-image: url('../gen_img/agent_admin_bg.jpg');  background-repeat: no-repeat; background-size: 100vw 100vh;  ">
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-5 text-white">
                                <div class="card shadow-lg border-0 rounded-lg mt-5 bg-dark">
                                    <div class="card-header"><h3 class="text-center font-weight-light my-4">TEAM LEAD<br /> LOGIN</h3>
                                </div>
                                    <div class="card-body">
								...
								<form method="POST"   id="user_login_form">
                                            ...
                                            <div class="form-group d-flex align-items-center justify-content-between mt-4 mb-0">
												...
												<input type="submit" name="user_login" id="user_login" class="btn btn-primary" value="Log In">
                                            </div>
                                        </form>
