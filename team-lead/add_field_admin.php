												...
												<div class="card-body">
													<div class="table-responsive">
														  <form method="POST"   id="user_register_form">
															...
															<label>Teal Lead ID  </label>
															<input type="text" name="registrar" value="<?php echo $marketer_code; ?>"  id="registrar" class="form-control py-4" Readonly />
															</div>
                                                            ...
                                                            <input class="form-control py-4" placeholder="Marketer Username"   type="email" name="user_email_address" id="user_email_address" class="form-control" data-parsley-checkemail data-parsley-checkemail-message='<span style="color:red;">This field admin email address already taken</span>' required />
