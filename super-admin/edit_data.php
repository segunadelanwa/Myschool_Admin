...
<html lang="en">
    <head>
		...
		require("../header.php");
			...
			$output = 'Team Lead';
			$Loader->query ="SELECT * FROM `0_team_lead` WHERE team_lead_id = '$data_id'";
			$result = $Loader->query_result();
													...
													<div class="table-responsive">
														...
														if($name == 'field_admin'){
															...
															echo' <form method="POST"   id="user_register_form">
																...
																<input class="form-control " value="'.$marketer_code.'"   type="text" name="fieldAdminCode" id="fieldAdminCode" class="form-control" readonly /> 
																</div>
																...
																<input class="form-control "     type="file" name="field_operator_photo" id="field_operator_photo" class="form-control"    />
																<br/>
																</div>
																...
																<input type="text" name="acct_name"  value="'.$acct_name.'" id="acct_name" class="form-control "   />
																</div>

																<div class="form-group">			
																<label>Account Number  </label>
																<input type="text" name="acct_number" value="'.$acct_number.'"  id="acct_number" class="form-control "   />
																</div>
															...
															echo'
																...
																<div class="form-group">	
																<label>School Code </label>
																<input class="form-control " value="'.$school_code.'"   type="text" name="school_code" id="school_code" class="form-control" readonly />
															...
															<option  value="'.$student_class.'" selected="selected">'.$student_class.'</option> 
																...
																<input class="form-control " value="'.$class_rep.'"   type="text" name="class_rep" id="class_rep" class="form-control"  />
														  ...
														  echo'
															...
															<div class="form-group">
																...
																<input type="text" name="school_bgcolor" value="'.$school_bgcolor.'"  id="school_bgcolor" class="form-control "    />
																</div>
																...
																<input type="text" name="text_code"     value="'.$text_code.'"  id="text_code" class="form-control "    />
																</div>															
														  ...
														  ';
															...
															<input type="text" name="subject" value="'.$sub_title.'"  id="subject" class="form-control "   required />
															</div>
															...
															$TeamLeadnNew = "../$Teamlead /$photo";
															echo' <form method="POST"   id="user_register_form">
															

																<div class="form-group">
																<label>Team Lead ID </label>
																<input class="form-control " value="'.$team_lead_id.'"   type="text" name="team_lead_id" id="team_lead_id" class="form-control" readonly /> 
																</div>
																...
																<div class="form-group">	
																<label>Field Admin Photo  </label>
																<img src="'.$TeamLeadnNew.'"  style="height:100px"> 
																<input class="form-control "     type="file" name="field_operator_photo" id="field_operator_photo" class="form-control"    />
																<br/>
																</div>
																...
																<input type="text" name="acct_number" value="'.$acct_number.'"  id="acct_number" class="form-control "   />
																		...
																		<input type="hidden" name="page"   value="updateUserData" />
																		<input type="hidden" name="action" value="team_lead" />
