                ...
                <main>
                    <div class="container-fluid">
                        <h4 class="mt-4"> 
                              ...
                              <?php
                                    if($_GET["name"] == 'fieldAdmin'){
                                    echo $result = "Field Admin Onboarded schools ";
                                    }
                                    else if($_GET["name"] == 'TeamLead'){
                                    echo $result = "Team Lead Onboarded schools ";
                                    }
                              ?>
						</h4>
                                    ...
                                    <table class="table table-bordered" id="dataTable_1" width="100%" cellspacing="0">
                                        ...
                                        <tbody> 
                                           <?php 
                                                ...
                                                if($_GET["name"] == 'fieldAdmin'){
                                                    $result = $Loader-> FadminOnboardedSchools($officer);
                                                }
                                                else if($_GET["name"] == 'TeamLead'){
                                                    $result = $Loader-> TeamLeadOnboardedSchools($officer);
                                                }
