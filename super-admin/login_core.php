...
<html lang="en">
    <head>
		...
		?>
        <meta property='og:image'         content='https://adminportal.com.ng/login/gen_img/super_admin_bg.jpg'>
        <meta property='twiter:image'     content='https://adminportal.com.ng/login/gen_img/super_admin_bg.jpg'>
        <meta property='og:title'         content="SUPER ADMIN LOGIN  ">
        <meta property="og:image:type"    content="image/jpeg">
        <meta property="og:image:width"   content="700">
        <meta property="og:image:height"  content="700">
        <meta property='og:description'   content="Super admin access login" >	
        <meta property='og:url'           content='https://adminportal.com.ng/login/gen_img/super_admin_bg.jpg'>
        <meta property='og:site_name'     content="SUPER ADMIN LOGIN"> 
        <meta property='og:type'          content='https://adminportal.com.ng/login/gen_img/super_admin_bg.jpg'>

		<title>SUPER ADMIN LOGIN </title>
    </head>
    <body class="bg-primary" style="background-image: url('../gen_img/super_admin_bg.jpg');  background-repeat: no-repeat; background-size: 100vw 100vh;  ">
