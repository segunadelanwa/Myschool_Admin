...
<head> 
		...
		<?php
             include("../header.php"); 
				...
				$id = $_GET['ticket'];
				$result = $Loader->FetchTicketByID($_GET['ticket']); 
                                ...
                                echo'       
                                 <div class="container" style="background-color:white;margin-bottom:30px;border-left:5px solid #000">
                                     ...
                                     <span data-toggle="modal" data-target="#reply'.$id.'"  class="btn btn-primary">Reply Ticket</span> 
                                      <span  data-toggle="modal" data-target="#close'.$id.'" class="btn btn-dark">Close Ticket</span>  <span class="btn btn-white">Resolution Rated: '.$rateStar.'</span>
                                  </div>';
                                    ...
                                    <div class="modal fade" id="close'.$id.'" tabindex="-1" role="dialog" aria-labelledby="close'.$id.'Label">
                                      ...
                                      <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                    ...
                                                    ';
                                                        echo" <input type='button' class='btn btn-primary' onclick='getTestscore($id)' value='Close Ticket'>";
                                                    echo'
