						...
						Ticket   Backlog
										   ...
										   <div class="col-xl-4 col-md-4"  >
													<div class="card bg-danger text-white mb-4">
														...
														<div class="card-body"><center><h2 ><?php echo $Loader-> OpenTicket($admincode)   	?> </h2></center> ESCALATED TICKET</div> 
												...
												<div class="col-xl-4 col-md-4"  >
													<div class="card bg-dark text-white mb-4">
														...
														<div class="card-body"><center><h2 ><?php echo $Loader-> OpenTicket($admincode)   	?> </h2></center>BACKLOG TICKET</div> 
														<div class="card-footer d-flex align-items-center justify-content-between">
															<a class="small text-white stretched-link" href="ticket_review.php">View Backlog</a>
															<div class="small text-white"><i class="fas fa-angle-right"></i></div>
														</div>
