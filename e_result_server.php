...
class ResultServer{
	 ...
	 function EserverResultFetch($online_stu_id)
	{
			...
			//$i=0;
				...
				echo $success =' 
     <div style="border:2px solid'.$school_bgcolor.';background-color:white;" >
                    ...
                    <div class="p-3 pb-4"  >							
						...
						foreach($result as $row)
						{
								...
								$grade = $this->GradeCal($result_1);
									echo$data="
								<div style='display:flex;font-size:217x;justify-content:space-around;text-align:left;height:15px';border-bottom:5px solid #eee;margin-bottom:5px;padding-top:15px>   
								...
								<div style='width:10%;' class='btn ' ><b> ".$grade." </b></div>
								</div>
								...
								$grade = $this->GradeCal($result_2);
									echo$data="
								<div style='display:flex;font-size: 17px;justify-content:space-around;text-align:left;height:15px;border-bottom:5px solid #eee;margin-bottom:5px;padding-top:15px'>  
								...
								$grade = $this->GradeCal($result_50);
									echo$data="
								<div style='display:flex;font-size: 17px;justify-content:space-around;text-align:left;height:15px;border-bottom:5px solid #eee;margin-bottom:5px;padding-top:20px'>  
				...
				';	
						echo $data ='  
							...
							<div class="card"  style="border-bottom:5px solid #eee;">
							...
							<div class="card" style="border-bottom:5px solid #eee;">
					         ...
					         <div class="p-3">
										...
										<div   style="border-bottom:5px solid #eee;">
												...
												<div style="display:flex;font-size: 20px;justify-content:space-around;text-align:left" > 													<div style="width:20%;font-size:14px">65% - 69% </div>
										...
										<div   style="border-bottom:5px solid #eee;">
												...
												<div style="display:flex;font-size: 20px;justify-content:space-around;text-align:left" > 													<div style="width:20%;font-size:14px">55% - 59% </div>
								            ...
								            <table class="table table-bordered"   width="100%" cellspacing="0">
												...
												<thead>
														...
														<div style="display:flex">
															...
															<h6 style="text-transform:lowercase;">School Website:'.$school_website.' </h6>
