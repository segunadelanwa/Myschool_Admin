												...
												<div class="card-body">
													<div class="table-responsive">
														  ...
														  <form method="POST"   id="user_register_form">
															  ...
															  <input class="form-control " value="<?php echo$result=$Loader->StudentNoGenerator(); ?>"   type="text" name="student_code" id="student_code" class="form-control" readonly />
  
															  </div>
															  <div class="form-group">	
															  <label>Default Password </label>
															  <input class="form-control " value="000000"   type="text" name="password" id="password" class="form-control" readonly />
  
															  </div>
															<div class="form-group">	
															<label>School Code </label>
                                                            <input class="form-control " value="<?php echo$school_code; ?>"   type="text" name="school_code" id="school_code" class="form-control" readonly />
                                                            ...
                                                            <input class="form-control " value="<?php echo$parentCode; ?>"   type="text" name="parent_code" id="parent_code" class="form-control" readonly  required/>
															...
															<select id='teacher_code' name='teacher_code' class="form-control" required>
															        <option disabled="disabled" selected="selected">---Select School Teacher----</option>
																	...
																	<?php
																		...
																		echo"<option  value='$teacher_code' class='text-dark'> $full_name </option>";
																		}
																	?>
                                                            ...
                                                            <input class="form-control"    type="file" name="student_photo" id="student_photo" class="form-control" required />
                                                            ...
                                                            <input class="form-control " placeholder="Student No"   type="text" name="schl_stu_no" id="schl_stu_no" class="form-control"   />
                                                            ...
                                                            <input class="form-control " placeholder="student fullname"   type="text" name="student_name" id="student_name" class="form-control" required />
