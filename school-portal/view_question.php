		   ...
		   <div id="layoutSidenav_content">
                ...
                <main>
                    <div class="container-fluid">
                        <h1 class="mt-4"> 
					          <i class="fas fa-book"></i>Teachers Questions  
						</h1>
		 ...
		 <div class="table-responsive">
	   		    ...
	   		    <div id="otpupdatebox" style="background-color:white; padding:50px;margin-top:10px">
                    ...
                    <?php 
                                    ...
                                    $Loader->query = "SELECT * FROM `50_question_table` WHERE  school_code='$school_code' AND cbt_status !='general'"; 
                                        ...
                                        <div class="card-body">
                                            <div class="table-responsive">
                                                <table class="table table-bordered" id="dataTable_1" width="100%" cellspacing="0">
                                                                        ...
                                                                        $teacher_code =  $Loader-> TeacherNameByEmail($active['teacher_code']);	 
                                                                        ...
                                                                        $subject =  $Loader-> FecthSingleSubject($active['cbt_subject']);	 
                                                                              ...
                                                                              echo' 
                                                                                ...
                                                                                <a href="edit_question.php?question_id='.$active['id'].'&type=edit">   </a> ';
