...
<html lang="en">
    <head>
		...
		?>
        <meta property='og:image'         content='https://adminportal.com.ng/login/gen_img/school_admin_bg.png'>
        <meta property='twiter:image'     content='https://adminportal.com.ng/login/gen_img/school_admin_bg.png'>
        <meta property='og:title'         content="SCHOOL ADMIN LOGIN  ">
        <meta property="og:image:type"    content="image/jpeg">
        <meta property="og:image:width"   content="700">
        <meta property="og:image:height"  content="700">
        <meta property='og:description'   content="School admin access login" >	
        <meta property='og:url'           content='https://adminportal.com.ng/login/gen_img/school_admin_bg.png'>
        <meta property='og:site_name'     content="SCHOOL ADMIN LOGIN"> 
        <meta property='og:type'          content='https://adminportal.com.ng/login/gen_img/school_admin_bg.png'>

		<title> SCHOOL PORTAL LOGIN </title>
    </head>
    <body class="bg-primary" style="background-image: url('../gen_img/school_admin_bg.png');  background-repeat: no-repeat; background-size: 100vw 100vh;  ">
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-5">
                                <div class="card shadow-lg border-0 rounded-lg mt-5 ">
                                    <div class="card-header"><h3 class="text-center font-weight-light my-4">SCHOOL PORTAL <br />
                                   LOGIN</h3>
                                </div>
                                    <div class="card-body">
