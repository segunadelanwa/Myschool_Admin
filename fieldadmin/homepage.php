                        ...
                        <div class="row"  >
                            ...
                            <div class="col-xl-4 col-md-4"  >
                                <div class="card bg-success text-white mb-4">
                                    ...
                                    <div class="card-body"><center><h2 ><?php echo$outNet   	?> </h2></center> TOTAL EARNING</div> 
                                    <div class="card-footer d-flex align-items-center justify-content-between">
                            ...
                            <div class="col-xl-4 col-md-4"  >
                                <div class="card bg-danger text-white mb-4">
                                    ...
                                    <div class="card-body"><center><h2 ><?php echo$historyCount; 	?> </h2></center> PAYMENT HISTORY</div> 
                                    <div class="card-footer d-flex align-items-center justify-content-between">
                                        <a class="small text-white stretched-link" href="#field_admin">View Details</a>
                                        <div class="small text-white"><i class="fas fa-angle-right"></i></div>
                                    </div>
